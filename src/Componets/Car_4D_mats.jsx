	...
	const categories = [
		{
			...
			description: "Durable 5-layer mats that protect your car floor. Comfortable, easy to clean and water resistant.",
			route: "/5d-mats",
			color: "#00b7ff",
		},
		{
			...
			description: "Ultra-premium 7-layer mats for complete protection. Built to last with superior grip and durability.",
			route: "/7d-mats",
			color: "#2be57a",
		},
		{
			...
			description: "Stylish vinyl flooring with a modern finish. Easy to install and budget-friendly for a quick upgrade.",
